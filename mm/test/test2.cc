...
// names
using NameName = Mm::Utils::StaticString<'n', 'a', 'm', 'e'>;
using ArrayName = Mm::Utils::StaticString<'a', 'r', 'r', 'a', 'y'>;
using TypeName = Mm::Utils::StaticString<'t', 'y', 'p', 'e'>;

using NameAttr = Mm::Xml::StringAttr<NameName>;

using Array = Mm::Xml::NodeBase<
  // attributes
  Kr::TypeList<
  ...
  Kr::TypeList<
    ...
    Mm::Xml::OptionalChild<TypeName, TypeTag, Mm::Xml::UseStdOptional>
    >
  >;

using Type = Mm::Xml::NodeBase<
  // attributes
  Kr::TypeList<
    // name attribute - string
    NameAttr
  ...
  Kr::TypeList<
    ...
    Mm::Xml::OptionalChild<ArrayName, ArrayTag, Mm::Xml::UseStdUniquePtr>,
    // type child - vector
    Mm::Xml::VectorChild<TypeName, TypeTag>
    >
  >;

using Root = Mm::Xml::Root<TypeName, TypeTag>;
...
class Impl
{
  static_assert (Mm::Utils::IsStaticString<Str>::value, "Str is a StaticString type");
...
main (int, char** argv)
{
  ...
  */
  ...
  Mm::Xml::Base::Document doc (argv[1]);
