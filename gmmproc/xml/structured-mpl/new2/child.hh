...
public:
  ...
  class GetAccessInfo
  {
    ...
    private:
      ...
      using GettersMap = Mpl::ApplyT<typename BasicP::GetGetters, StorageP>;
...
public:
  ...
  {
  public:
    using Type = std::tuple<Mpl::ApplyT<typename ChildP::GetContainedType>...>;
  };
  ...
  class GetAccessInfo
  {
    ...
    {
    public:
      using Type = Mpl::ApplyT<Detail::GetGroupAccessInfoT, StorageP, ChildP...>;
    };
  };
