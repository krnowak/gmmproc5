...
// MF - my metafunc (with capitalized Apply and Type members)
...
// my trivial metafunc (capitalized Type member)
...
// mixed metafunc (with both capitalized and noncapitalized type and apply members)
...
// mixed trivial metafunc (with both capitalized and noncapitalized type members)
...
class IsMetaFunc : public std::integral_constant<bool, HasApplyMember<MetaFuncP>::value>
{};

static_assert (IsMetaFunc<Test::MF>::value == true,    "IsMetaFunc works");
static_assert (IsMetaFunc<Test::MF1>::value == false,  "IsMetaFunc works");
static_assert (IsMetaFunc<Test::MF2>::value == false,  "IsMetaFunc works");
...
static_assert (IsMetaFunc<Test::MMF1>::value == false, "IsMetaFunc works");
static_assert (IsMetaFunc<Test::MMF2>::value == false, "IsMetaFunc works");
...
template <typename MetaFuncP>
class IsTemplatedMetaFunc : public std::integral_constant<bool, HasApplyTemplateMember<MetaFuncP>::value>
{};

static_assert (IsTemplatedMetaFunc<Test::MF>::value == false,   "IsTemplatedMetaFunc works");
static_assert (IsTemplatedMetaFunc<Test::MF1>::value == true,   "IsTemplatedMetaFunc works");
static_assert (IsTemplatedMetaFunc<Test::MF2>::value == true,   "IsTemplatedMetaFunc works");
static_assert (IsTemplatedMetaFunc<Test::BMF>::value == false,  "IsTemplatedMetaFunc works");
static_assert (IsTemplatedMetaFunc<Test::BMF1>::value == false, "IsTemplatedMetaFunc works");
static_assert (IsTemplatedMetaFunc<Test::BMF2>::value == false, "IsTemplatedMetaFunc works");
static_assert (IsTemplatedMetaFunc<Test::MMF>::value == false,  "IsTemplatedMetaFunc works");
static_assert (IsTemplatedMetaFunc<Test::MMF1>::value == true,  "IsTemplatedMetaFunc works");
static_assert (IsTemplatedMetaFunc<Test::MMF2>::value == true,  "IsTemplatedMetaFunc works");
static_assert (IsTemplatedMetaFunc<Test::TF>::value == false,   "IsTemplatedMetaFunc works");
static_assert (IsTemplatedMetaFunc<Test::BTF>::value == false,  "IsTemplatedMetaFunc works");
static_assert (IsTemplatedMetaFunc<Test::MTF>::value == false,  "IsTemplatedMetaFunc works");

template <typename MetaFuncP>
class IsBoostMetaFunc : public std::integral_constant<bool, HasBoostApplyMember<MetaFuncP>::value>
{};
...
static_assert (IsBoostMetaFunc<Test::BMF1>::value == false, "IsBoostMetaFunc works");
static_assert (IsBoostMetaFunc<Test::BMF2>::value == false, "IsBoostMetaFunc works");
static_assert (IsBoostMetaFunc<Test::MMF>::value == true,   "IsBoostMetaFunc works");
static_assert (IsBoostMetaFunc<Test::MMF1>::value == false, "IsBoostMetaFunc works");
static_assert (IsBoostMetaFunc<Test::MMF2>::value == false, "IsBoostMetaFunc works");
...
template <typename MetaFuncP>
class IsBoostTemplatedMetaFunc : public std::integral_constant<bool, HasBoostApplyTemplateMember<MetaFuncP>::value>
{};

static_assert (IsBoostTemplatedMetaFunc<Test::MF>::value == false,  "IsBoostTemplatedMetaFunc works");
static_assert (IsBoostTemplatedMetaFunc<Test::MF1>::value == false, "IsBoostTemplatedMetaFunc works");
static_assert (IsBoostTemplatedMetaFunc<Test::MF2>::value == false, "IsBoostTemplatedMetaFunc works");
static_assert (IsBoostTemplatedMetaFunc<Test::BMF>::value == false, "IsBoostTemplatedMetaFunc works");
static_assert (IsBoostTemplatedMetaFunc<Test::BMF1>::value == true, "IsBoostTemplatedMetaFunc works");
static_assert (IsBoostTemplatedMetaFunc<Test::BMF2>::value == true, "IsBoostTemplatedMetaFunc works");
static_assert (IsBoostTemplatedMetaFunc<Test::MMF>::value == false, "IsBoostTemplatedMetaFunc works");
static_assert (IsBoostTemplatedMetaFunc<Test::MMF1>::value == true, "IsBoostTemplatedMetaFunc works");
static_assert (IsBoostTemplatedMetaFunc<Test::MMF2>::value == true, "IsBoostTemplatedMetaFunc works");
static_assert (IsBoostTemplatedMetaFunc<Test::TF>::value == false,  "IsBoostTemplatedMetaFunc works");
static_assert (IsBoostTemplatedMetaFunc<Test::BTF>::value == false, "IsBoostTemplatedMetaFunc works");
static_assert (IsBoostTemplatedMetaFunc<Test::MTF>::value == false, "IsBoostTemplatedMetaFunc works");
...
template <typename MetaFuncP>
class IsBoostified : public std::integral_constant<bool, IsBoostTrivialMetaFunc<MetaFuncP>::value || IsBoostMetaFunc<MetaFuncP>::value || IsBoostTemplatedMetaFunc<MetaFuncP>::value>
{};
...
{
private:
  using EnabledTemplatedMetaFunc = void;
  using EnabledMetaFunc = void;
  using EnabledTrivialMetaFunc = void;
  using EnabledBoostified = void;
...
public:
  ...
  class Apply<MetaFuncP, std::enable_if_t<!IsBoostified<MetaFuncP>::value &&
                                          !IsMetaFunc<MetaFuncP>::value &&
                                          IsTemplatedMetaFunc<MetaFuncP>::value &&
                                          !IsTrivialMetaFunc<MetaFuncP>::value,
                                          EnabledTemplatedMetaFunc>>
  {
  public:
    class Type
    {
  ...
  public:
    ...
    public:
      ...
      {
      public:
        using type = typename MetaFuncP::Apply::Type;
      };
    };
  };
